(() => {
  var __webpack_modules__ = {
    ...
    2: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(607);
    ...
    638: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Node = __nccwpck_require__(808);
    ...
    607: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Comment = __nccwpck_require__(638);
      let Declaration = __nccwpck_require__(193);
      let Node = __nccwpck_require__(808);
      let { isClean, my } = __nccwpck_require__(963);
    ...
    653: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let AtRule = __nccwpck_require__(2);
      let Comment = __nccwpck_require__(638);
      let Declaration = __nccwpck_require__(193);
      let Input = __nccwpck_require__(778);
      let PreviousMap = __nccwpck_require__(126);
      let Root = __nccwpck_require__(628);
      let Rule = __nccwpck_require__(547);
    ...
    778: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let CssSyntaxError = __nccwpck_require__(804);
      let PreviousMap = __nccwpck_require__(126);
      let terminalHighlight = __nccwpck_require__(205);
    ...
    388: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(607);
      let Document = __nccwpck_require__(434);
      let MapGenerator = __nccwpck_require__(175);
      let parse = __nccwpck_require__(439);
      let Result = __nccwpck_require__(387);
      let Root = __nccwpck_require__(628);
      let stringify = __nccwpck_require__(237);
      let { isClean, my } = __nccwpck_require__(963);
      let warnOnce = __nccwpck_require__(821);
    ...
    588: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let MapGenerator = __nccwpck_require__(175);
      let parse = __nccwpck_require__(439);
      const Result = __nccwpck_require__(387);
      let stringify = __nccwpck_require__(237);
      let warnOnce = __nccwpck_require__(821);
      class NoWorkResult {
        constructor(processor, css, opts) {
    ...
    439: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Container = __nccwpck_require__(607);
      let Input = __nccwpck_require__(778);
      let Parser = __nccwpck_require__(512);
    ...
    616: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Declaration = __nccwpck_require__(193);
      let Document = __nccwpck_require__(434);
      let fromJSON = __nccwpck_require__(653);
      let Input = __nccwpck_require__(778);
      let LazyResult = __nccwpck_require__(388);
      let list = __nccwpck_require__(789);
      let Node = __nccwpck_require__(808);
      let parse = __nccwpck_require__(439);
      let Processor = __nccwpck_require__(899);
      let Result = __nccwpck_require__(387);
      let Root = __nccwpck_require__(628);
      let Rule = __nccwpck_require__(547);
      let stringify = __nccwpck_require__(237);
      let Warning = __nccwpck_require__(197);
    ...
    899: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Document = __nccwpck_require__(434);
      let LazyResult = __nccwpck_require__(388);
      let NoWorkResult = __nccwpck_require__(588);
      let Root = __nccwpck_require__(628);
      class Processor {
        constructor(plugins = []) {
          this.version = "8.4.43";
    ...
    628: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(607);
      let LazyResult, Processor;
    ...
    237: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Stringifier = __nccwpck_require__(289);
